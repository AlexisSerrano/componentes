        ...
        <form v-on:submit.prevent="validateBeforeSubmit" v-if="loader!=true">
            ...
            <div class="form-row">
                ...
                <div v-if="(this.notificacion)?this.notificacion.id==2 || this.notificacion.id==3 || this.tipo!='contacto':''" class="form-group col-md-4">
                    ...
                    <v-select :options="municipios" label="nombre" v-model="municipio" name="municipio" @input="getLocalidades" v-validate="'required'" :class="{ 'border border-danger': errors.has('municipio') || this.validacionesback.idMunicipio}" placeholder="Seleccione un municipio" :disabled="(this.notificacion)?notificacion.id==3 && this.tipo=='contacto':''"></v-select>
                ...
                <div v-if="(this.notificacion)?this.notificacion.id==2 || this.notificacion.id==3 || this.tipo!='contacto':''" class="form-group col-md-4">
                    ...
                    <v-select :options="localidades" label="nombre" v-model="localidad" name="localidad" @input="getCodigosPostales" v-validate="'required'" :class="{ 'border border-danger': errors.has('localidad') || this.validacionesback.idLocalidad}" placeholder="Seleccione una localidad" :disabled="(this.notificacion)?notificacion.id==3 && this.tipo=='contacto':''"></v-select>
                ...
                <div v-if="(this.notificacion)?this.notificacion.id==2 || this.notificacion.id==3 || this.tipo!='contacto':''" class="form-group col-md-4">
                    ...
                    <v-select :options="colonias" label="nombre" v-model="colonia" name="colonia"  v-validate="'required'" :class="{ 'border border-danger': errors.has('colonia') || this.validacionesback.idColonia}" placeholder="Seleccione una colonia" :disabled="(this.notificacion)?notificacion.id==3 && this.tipo=='contacto':''"></v-select>
                ...
                <div v-if="(this.notificacion)?this.notificacion.id==2 || this.notificacion.id==3 || this.tipo!='contacto':''" class="form-group col-md-4">
                    ...
                    <input type="text" name="calle" :class="{'input': true, 'form-control form-control-sm':true, 'border border-danger': errors.has('calle') || this.validacionesback.calle}" v-model="calle" placeholder="Ingrese la calle" v-validate="'required'" autocomplete="off" :readonly="(this.notificacion)?notificacion.id==3 && this.tipo=='contacto':''">
                ...
                <div v-if="(this.notificacion)?this.notificacion.id==2 || this.notificacion.id==3 || this.tipo!='contacto':''" class="form-group col-md-4">
                    ...
                    <input type="text" name="numInterno" class="input form-control form-control-sm" v-model="numInterno" placeholder="Ingrese el número interno" autocomplete="off" :readonly="(this.notificacion)?notificacion.id==3 && this.tipo=='contacto':''">
                </div>
