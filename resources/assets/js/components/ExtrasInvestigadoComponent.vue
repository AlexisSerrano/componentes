        ...
        <form v-on:submit.prevent="validateBeforeSubmit">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input  class="form-control form-control-sm" type="text" name="residencia" :class="{'input': true, 'form-control':true, 'border border-danger': errors.has('residencia')}" v-model="residencia" placeholder="Ingrese la residencia" v-validate="'required'" autocomplete="off" >
                ...
                <div class="form-group col-md-3">
                    ...
                    <input  class="form-control form-control-sm" type="text" name="vestimenta" :class="{'input': true, 'form-control':true, 'border border-danger': errors.has('vestimenta')}" v-model="vestimenta" placeholder="Ingrese la vestimenta" v-validate="'required'" autocomplete="off" >
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control form-control-sm" data-vv-name="señas particulares" :class="{'input': true, 'form-control':true, 'border border-danger': errors.has('señas particulares')}" v-model="particulares" placeholder="Ingrese las señas particulares" v-validate="'required'" autocomplete="off"></textarea>
