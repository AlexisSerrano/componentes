...
class involucradosSeeder extends Seeder
{
    public function run()
    {
        DB::table('involucrados')->insert([
            ['id'=>1,'nombre'=>'comparecencia completo','descripcion'=>'UAT'],
            ['id'=>2,'nombre'=>'conocido parcial','descripcion'=>'UAT'],
            ['id'=>3,'nombre'=>'qrr null','descripcion'=>'UAT'],
            ['id'=>4,'nombre'=>'victima u ofendido','descripcion'=>'UAT - UIPJ'],
            ['id'=>10,'nombre'=>'comparecencia completo','descripcion'=>'UIPJ'],
            ['id'=>11,'nombre'=>'conocido parcial','descripcion'=>'UIPJ'],
            ['id'=>12,'nombre'=>'qrr null','descripcion'=>'UIPJ']
