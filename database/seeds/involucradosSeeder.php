...
class involucradosSeeder extends Seeder
{
    public function run()
    {
        DB::table('involucrados')->insert([
            ['id'=>1,'nombre'=>'comparecencia completo','descripcion'=>''],
            ['id'=>2,'nombre'=>'conocido parcial','descripcion'=>''],
            ['id'=>3,'nombre'=>'qrr null','descripcion'=>''],
            ['id'=>10,'nombre'=>'comparecencia completo','descripcion'=>''],
            ['id'=>11,'nombre'=>'conocido parcial','descripcion'=>''],
            ['id'=>12,'nombre'=>'qrr null','descripcion'=>'']
