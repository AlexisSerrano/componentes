...
class DenunciadoFisicaUIPJEditRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'fechaNacimiento' => 'nullable|date|before:'.$before_date,
            'idEstadoOrigen' => 'required',
            'idMunicipioOrigen' => 'required',
            'sexo' => 'required',
            'curp' => 'nullable|alpha_num|min:17|max:18',
            'rfc' => 'nullable|alpha_num|min:8|max:13',/*no requerido*/ 
